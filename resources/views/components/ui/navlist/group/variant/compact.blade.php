...
<div class="
    ...
    <div @if($collapsable) x-on:click="expand()" @endif class="
            w-full rounded-box
        ...
        <x-ui.icon x-show="!expanded" name="chevron-up" style="display:none;" class="size-4" />
...
<div @if ($collapsable) x-show="expanded" x-collapse @endif class="
        [:has([data-collapsed]_&)_&]:m-0 ml-4.7 rtl:mr-4.7
