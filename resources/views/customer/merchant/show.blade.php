<x-layouts.marketplace
    title="{{ $merchant->company_name }} — Katering {{ $merchant->category ?? '' }}"
...
>
    <div class="space-y-10">
            ...
            <div class="px-5 pb-8 sm:px-8">
                <div class="-mt-10 flex flex-wrap items-end justify-between gap-4">
                    <div class="flex items-end gap-4">
                        ...
                        @endif
                        <div class="pb-1">
                            <h1 class="text-2xl font-semibold tracking-tight text-zinc-950 sm:text-3xl">{{ $merchant->company_name }}</h1>
        ...
        {{-- ======= CTA ======= --}}
        <section class="relative overflow-hidden rounded-xl border border-zinc-900 bg-zinc-950 p-8 text-white shadow-xs sm:p-10" aria-labelledby="cta-heading">
            <div class="relative z-10 max-w-2xl space-y-4">
                <h2 id="cta-heading" class="text-xl font-semibold tracking-tight text-white sm:text-2xl">Siap pesan dari {{ $merchant->company_name }}?</h2>
                <p class="text-xs font-normal leading-relaxed text-zinc-400 sm:text-sm">Pilih menu di atas dan tentukan tanggal pengiriman untuk tim kamu.</p>
                <a href="#menus-heading" class="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2 text-xs font-medium text-zinc-950 shadow-xs transition-colors hover:bg-zinc-100 sm:text-sm">
